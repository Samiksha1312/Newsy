  ...
  render() {
    return (
      ...
      />
          <Navbar />  
          <Routes>
            <Route exact path="/Newsy" element={<News setProgress={this.setProgress} apiKey={this.apiKey} key="general" pageSize={this.pageSize} country="in" category="general"/>}></Route>
